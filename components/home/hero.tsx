      ...
      <section className="relative overflow-hidden min-h-screen flex flex-col">
        <div className="container mx-auto px-4 py-24 sm:py-32 relative z-10 flex-1 flex flex-col">
          <div className="mx-auto max-w-4xl text-center flex-1 flex flex-col justify-center">
            ...
            >
              Because every lost item deserves a comeback story. Share what’s
              missing, discover what’s found, and reconnect through our campus
              web. A secure and responsible Lost & Found system for the VIT
              community.
            </motion.p>
            ...
            >
              ...
              >
                ...
                <motion.path
                  ...
                  initial={{ pathLength: 0, opacity: 0 }}
                  animate={{ pathLength: 1, opacity: 1 }}
                  transition={{ duration: 2.0, delay: 1.4, ease: "easeInOut" }}
                />
              </motion.svg>
              ...
              <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
                ...
                <Link href="/browse-found">
                  <div
                    className="group cursor-pointer border border-border gap-2 h-[60px] flex items-center p-[10px] rounded-full hover:shadow-lg transition-all duration-300"
                    style={{ backgroundColor: "#22C55E", boxShadow: "none" }}
                    onMouseEnter={(e) =>
                      (e.currentTarget.style.boxShadow =
                        "0 10px 25px -3px rgba(34, 197, 94, 0.5), 0 4px 6px -2px rgba(34, 197, 94, 0.1)")
                    }
                    onMouseLeave={(e) =>
                      (e.currentTarget.style.boxShadow =
