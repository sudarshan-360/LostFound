        ...
        <div className="container mx-auto px-4 py-24 sm:py-32 relative z-10 flex-1 flex flex-col">
          <div className="mx-auto max-w-4xl text-center flex-1 flex flex-col justify-center">
            ...
            >
              ...
              >
                <strong>Lost</strong> something? <br />
                <strong>Found</strong> something? <br />
            ...
            >
              Because every lost item deserves a comeback story. Share what’s missing, discover what’s found, and reconnect through our campus web. A secure and responsible Lost & Found system for the VIT community.
            </motion.p>
            ...
            >
              ...
              <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
                ...
                <a href="/find-items">
                  <div className="group cursor-pointer border border-border gap-2 h-[60px] flex items-center p-[10px] rounded-full hover:shadow-lg transition-all duration-300" style={{backgroundColor: '#22C55E', boxShadow: 'none'}} onMouseEnter={(e) => e.currentTarget.style.boxShadow = '0 10px 25px -3px rgba(34, 197, 94, 0.5), 0 4px 6px -2px rgba(34, 197, 94, 0.1)'} onMouseLeave={(e) => e.currentTarget.style.boxShadow = '0 10px 15px -3px rgba(0, 0, 0, 0.1), 0 4px 6px -2px rgba(0, 0, 0, 0.05)'}>
                    <div className="border border-white/20 bg-white/10 h-[40px] rounded-full flex items-center justify-center text-white">
                      <p className="font-medium tracking-tight mr-3 ml-3 flex items-center gap-2 justify-center text-base">
                        <Users className="h-4 w-4" />
                        Browse Found Items
                      </p>
                    </div>
                    <div className="text-white/80 group-hover:ml-4 ease-in-out transition-all size-[24px] flex items-center justify-center rounded-full border-2 border-white/20">
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        width="14"
                        height="14"
