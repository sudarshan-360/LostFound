...
export default function Features() {
  ...
  const [isRealTimeChatHovering, setIsRealTimeChatHovering] = useState(false);
            ...
            <div className="grid grid-cols-12 gap-4 justify-center">
                ...
                <div className="flex flex-col gap-4">
                  ...
                  <div className="text-md text-muted-foreground flex flex-col gap-2 text-sm">
                    <p className="max-w-[460px]">
                      Lost or found something? Post it instantly with details &
                      images for the VIT community.
                    </p>
                  </div>
                </div>
                <div className="pointer-events-none flex grow items-center justify-center select-none relative">
                  ...
                  >
                    ...
                    <motion.div
                      ...
                      initial={{ opacity: 0 }}
                      animate={
                        isQuickPostHovering ? { opacity: 1 } : { opacity: 0 }
                      }
                    ...
                    <div className="absolute inset-0 flex items-center justify-center">
                      <div className="flex flex-col items-center gap-6">
                        ...
                        <motion.button
                          ...
                          animate={
                            isQuickPostHovering ? { y: [0, -5, 0] } : { y: 0 }
                          }
              ...
              >
                <div className="flex flex-col gap-4">
                  ...
                  <div className="text-md text-muted-foreground flex flex-col gap-2 text-sm">
                    <p className="max-w-[460px]">
                      Secure access with Google Auth — only VIT Gmail accounts
                      allowed for trusted community.
                    </p>
                  </div>
                </div>
              ...
              >
                <div className="flex flex-col gap-4">
                  ...
                  <div className="text-md text-muted-foreground flex flex-col gap-2 text-sm">
                    <p className="max-w-[460px]">
                      Find items easily by category, location, or date with
              ...
              <motion.div
                className="group border-secondary/40 text-card-foreground relative col-span-12 flex flex-col overflow-hidden rounded-xl border-2 p-6 shadow-xl transition-all ease-in-out md:col-span-6 xl:col-span-6 xl:col-start-8"
                onMouseEnter={() => setIsRealTimeChatHovering(true)}
                onMouseLeave={() => setIsRealTimeChatHovering(false)}
                initial={{ opacity: 0, y: 50 }}
                animate={
                  isInView ? { opacity: 1, y: 0 } : { opacity: 0, y: 50 }
                }
              ...
              >
                <div className="flex flex-col gap-4">
                  ...
                  <div className="text-md text-muted-foreground flex flex-col gap-2 text-sm">
                    <p className="max-w-[460px]">
                      Connect directly with the finder/owner through instant
                      messaging for quick coordination.
                    </p>
                  </div>
                </div>
                <div className="flex grow items-center justify-center select-none relative min-h-[300px] p-4">
                  <div className="relative w-full max-w-sm">
                    <div className="bg-gradient-to-br from-pink-50 to-rose-100 dark:from-pink-900/20 dark:to-rose-900/20 rounded-2xl p-4 shadow-lg border border-pink-200 dark:border-pink-800">
                      <div className="space-y-3">
                        {/* Chat Header */}
                        <div className="flex items-center gap-3 pb-2 border-b border-pink-200 dark:border-pink-700">
                          ...
                          <motion.div
                            ...
                            animate={
                              isRealTimeChatHovering
                                ? { scale: [1, 1.5, 1] }
                                : { scale: 1 }
                            }
                            transition={{
                              duration: 1,
                              repeat: isRealTimeChatHovering
                                ? Number.POSITIVE_INFINITY
                                : 0,
                            }}
                          />
                        ...
                        <div className="space-y-2">
                          <motion.div
                            className="bg-white dark:bg-gray-800 rounded-lg p-2 text-xs shadow-sm"
                          ...
                          >
                            Hey! I found your black wallet near the library
                          </motion.div>
                          <motion.div
                            className="bg-pink-500 text-white rounded-lg p-2 text-xs ml-8 shadow-sm"
                            initial={{ opacity: 0, x: 20 }}
                            animate={
                              isRealTimeChatHovering
                                ? { opacity: 1, x: 0 }
                          ...
                          >
                            I'm at the main gate. Blue shirt 👕
                          </motion.div>
                        </div>

                        {/* Chat Input */}
                        <div className="flex items-center gap-2 pt-2">
                          <div className="flex-1 bg-white dark:bg-gray-800 rounded-full px-3 py-1 text-xs">
                            Type a message...
                          </div>
                          <motion.button
