...
const TestimonialCard = ({
  ...
  return (
    <div className="relative w-full max-w-xs overflow-hidden rounded-3xl border border-white/20 bg-gradient-to-b from-white/10 to-white/5 backdrop-blur-sm p-10 shadow-[0px_2px_0px_0px_rgba(255,255,255,0.1)_inset]">
